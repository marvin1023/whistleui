						...
						<div className="modal-body w-about-has-plugins">
							...
							<span className="w-about-dialog-ctn">
								...
								{compareVersion(latest, version) ? (<span className="w-about-latest-version">
									Latest version: <a className="w-about-github" title="How to update whistle" href="https://whistle.gitbooks.io/help_zh/content/update.html" target="_blank">{latest}</a><br/>
								</span>) : ''}
