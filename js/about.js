						...
						<div className="modal-body w-about-has-plugins">
							...
							<span className="w-about-dialog-ctn">
								...
								{compareVersion(latest, version) ? (<span className="w-about-latest-version">
									Latest version: <a className="w-about-github" title="How to update whistle" href="https://github.com/avwo/whistle/wiki/%E6%9B%B4%E6%96%B0whistle" target="_blank">{latest}</a><br/>
								</span>) : ''}
